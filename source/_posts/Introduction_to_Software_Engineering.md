...
The system is designed so that it can be delivered in pieces, enabling the users to have some functionality while the rest is being developed. Thus, there 2 systems functioning in parallels: the **production system** and the **development system**. 
